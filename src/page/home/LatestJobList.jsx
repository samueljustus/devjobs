          ...
          <li className="flex flex-col gap-2 mb-8 border-b-2 border-[#f2f2f2] pb-5">
            ...
            <div className="flex flex-row justify-between">
              <div className="flex flex-row items-center gap-2">
                ...
                <div>
                <p className="font-base font-Arial text-[#9999b7] cursor-pointer">Woo Network</p>
                <p className="font-base font-helvetica font-bold text-[#1b1b1b] cursor-pointer">Frontend Developer</p>
                </div>
              </div>
              <div >
